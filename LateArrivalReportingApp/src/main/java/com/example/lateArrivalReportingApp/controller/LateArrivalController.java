...
public class LateArrivalController {
    ...
    public String submitDelay(
        ...
        String ymd = LocalDate.now()
                .format(DateTimeFormatter.ofPattern("yyyyMMdd"));

        if (lateTblRepository.existsByIdEmpIdAndIdContactDate(empId, ymd)) {
        ...
        try {
            ...
            LateTblId id = new LateTblId(empId, ymd);
            entry.setId(id);
            ...
            entry.setTrainId(
                    (trainId != null && !trainId.isEmpty()) ? trainId : null);
            ...
            logger.info(
                    "Saved LateTbl: empId={}, reason={}, trainId={}, eta={}",
                    empId,
                    delayReason,
                    trainId,
                    entry.getEta());
